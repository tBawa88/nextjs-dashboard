    ...
    <form method='POST' action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          {/* showing erros for not selecting customers */}
        ...
        <fieldset aria-describedby='invoice-status-error'>
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              ...
              <div id='invoice-status-error' aria-live='polite'>
                {/* showing erros for not selecting customers */}
        ...
        {formState.message && <p className='mt-2 text-sm text-red-500'>{formState.message}</p>}
